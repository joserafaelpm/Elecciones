...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="/Elecciones/RegistrarVotante/">Registrar Votante</a></li>
				</ul>
			</div>
		</div>
	</nav>
	...
	<section class="page-section bg-dark text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="row">
            <a href="${pageContext.request.contextPath}/Voto.jsp" class="btn btn-xl btn-outline-light">Voto Registrados</a>        
